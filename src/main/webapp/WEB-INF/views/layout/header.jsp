...
<%--    <script src="https://cdn.jsdelivr.net/npm/jquery@3.6.3/dist/jquery.slim.min.js"></script>--%> <%-- jquery.slim.min.js 는 ajax 지원하지 않으므로 제거--%>
...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <a class="navbar-brand" href="/blog">Winone</a>
